...
namespace DxSampleDialogServices {
    public partial class FlyoutDialogServiceUserControl : XtraUserControl {
        public FlyoutDialogServiceUserControl() {
            InitializeComponent();
            #region SetUp
