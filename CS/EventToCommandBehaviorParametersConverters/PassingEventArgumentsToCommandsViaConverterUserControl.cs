...
namespace DxSampleEventToCommandBehaviorParametersConverters {
    public partial class PassingEventArgumentsToCommandsViaConverterUserControl : XtraUserControl {
        public PassingEventArgumentsToCommandsViaConverterUserControl() {
            InitializeComponent();
            #region SetUp
            ...
            #region #passingEventArgumentsToCommandsViaConverter
            ...
            #endregion #passingEventArgumentsToCommandsViaConverter
        }
        #region CleanUp
        void OnDisposing() {
